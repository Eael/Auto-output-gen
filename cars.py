...
def process_data(data):
  ...
  for item in data:
    ...
    if item["total_sales"] > max_sales["total_sales"]:
       max_sales = item
    #car_year_sales.setddefault(item["car"]["car_year"], 0) += item["total_sales"]
...
def main(argv):
  ...
  reports.generate("/tmp/report.pdf", "Sales Summary for last month", "<br/>".join(summary), cars_dict_to_table(data))
  print("PDF OK")
